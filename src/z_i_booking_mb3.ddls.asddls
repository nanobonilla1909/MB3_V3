@AbapCatalog.sqlViewName: 'ZVBOOK_MB3'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Interface - Booking'

define view Z_I_BOOKING_MB3 
    as select from ztb_booking_mb3 as Booking

composition [0..*] of Z_I_BOOKSUPPL_MB3 as _BookingSupplement

association to parent Z_I_TRAVEL_MB3 as _Travel 
